...
my_id = 1
g = 8888
for pid in path_folders[876:]: #[1:10]:
           ...
           for k in range(-3,3):
               ...
               if MalMean <=2:
                ...
                #name = path + pid + '\\' + lab + str(g) + str('Series:') + str(my_id) + '.tif'
                   ...
                   im.save(namepath + str('Nod_') + str(nodule_count) + 'Slice_' + str(k+5) + 'Malignancy_' + str(MalMean) + '.tif')
               elif MalMean >= 3.75:
                   lab='malignant'
                   ...
                   lab = 'SuspBen'
                   if not os.path.exists('C:\\Users\\User\\SPN3D_1\\LIDC3D\\suspben\\' +str(g)+ '\\'):
                       os.mkdir('C:\\Users\\User\\SPN3D_1\\LIDC3D\\suspben\\' +str(g)+ '\\')
                   namepath ='C:\\Users\\User\\SPN3D_1\\LIDC3D\\suspben\\' +str(g)+ '\\'
                   im.save(namepath + str('Nod_') + str(nodule_count) + 'Slice_' + str(k+5) + 'Malignancy_' + str(MalMean) + '.tif')
               elif MalMean>3:
                   lab = 'SuspMal'
                   if not os.path.exists('C:\\Users\\User\\SPN3D_1\\LIDC3D\\suspmal\\' +str(g)+ '\\'):
                       os.mkdir('C:\\Users\\User\\SPN3D_1\\LIDC3D\\suspmal\\' +str(g)+ '\\')
                   namepath ='C:\\Users\\User\\SPN3D_1\\LIDC3D\\suspmal\\' +str(g)+ '\\'
                   im.save(namepath + str('Nod_') + str(nodule_count) + 'Slice_' + str(k+5) + 'Malignancy_' + str(MalMean) +  '.tif')   
